...
//  전체 회원정보 넘기기
    @GetMapping("/list")
    public String list(MemberSearchDTO memberSearchDTO, Model model){
//        List<MemberListDTO> list = memberService.selectListMember(memberListDTO);
        List<MemberListDTO> memberList = memberService.findMemberList(memberSearchDTO);
